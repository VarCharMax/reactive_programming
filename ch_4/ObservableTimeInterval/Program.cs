...
namespace ObservableTimeInterval;
...
internal class Program
{
  static void Main(string[] args)
  {
    ...
    sourcingSequence.Subscribe(value => Console.WriteLine("{0}", value));

    //a sequence recording the time interval of the sourcing sequence
    var diagnosticSequence = sourcingSequence.TimeInterval();
    diagnosticSequence.Subscribe(interval => Debug.WriteLine(string.Format("Message flowing in {0:N0}ms", interval.Interval.TotalMilliseconds)));
